...
<!-- action bar -->
		<div class="action-bar small-12 row align-right align-top show-for-medium ">
			<h5 class="phone-number show-for-medium">(402) 477-5692</h5>
		</div>
<!-- logo with link home -->
		<div class="small-11 row logo align-center"><a href="http://omahahls.com/expresspawntemp/lincoln/"><img src="<?php bloginfo('template_directory'); ?>/img/logo.svg"></a></div>
